...
public class PermissionService : IPermissionService
{
    ...
    private readonly IUserRetrieveService userRetriever; // winauth
    ...
    public PermissionService(ITwoLevelCache cache,
        ...
        IUserRetrieveService userRetriever // winauth
        )
    {
        ...
        this.userRetriever = userRetriever ?? throw new ArgumentNullException((nameof(userRetriever))); // winauth
    }
    ...
    public bool HasPermission(string permission)
    {
        ...
        // winauth addition:
        if (userRetriever.ByUsername(userAccessor.User?.Identity?.Name).IsActive == 0)
        {
            return false;
        }
