...
public partial class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        // winauth  change, may not be needed:  move services.AddAntiforgery... AFTER the builder line and after all the AddAuthentication stuff (whichever version you use)
        ...
        {
            //  winauth try removing this next line if you have problems: options.Filters.Add(typeof(AutoValidateAntiforgeryIgnoreBearerAttribute));
            //  see doc page.
        ...
        /* winauth change, may not be needed:  replace this: */
        ...
        services.AddAuthentication(o => {
            o.DefaultScheme = IISServerDefaults.AuthenticationScheme;
            o.DefaultAuthenticateScheme = IISServerDefaults.AuthenticationScheme;
            o.DefaultChallengeScheme = IISServerDefaults.AuthenticationScheme;
            o.DefaultSignInScheme = IISServerDefaults.AuthenticationScheme;
        }).AddCookie("WinAuth", "WinAuth", o =>
        {
            o.Cookie.Name = "WinAuth";
            o.LoginPath = new PathString("/Account/Login/");
            o.AccessDeniedPath = new PathString("/Account/AccessDenied");
            o.ExpireTimeSpan = TimeSpan.FromMinutes(30);
            o.SlidingExpiration = true;
      ...
      */
        /* winauth: 
        // the following is the default, but is put here to underscore that,
        // if set to false, you'd get the login screen for Windows users.
        // they would need to put in their domain\user name, and (because pw field is currently required,
        // although that could be changed) any value for a pw.
