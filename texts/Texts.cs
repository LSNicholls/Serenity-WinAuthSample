...
public static partial class Texts
{
    ...
    public static class Forms
    {
        public static class Membership
        {
            ...
            {
                public static readonly LocalText ActivateEmailSubject = "Activate Your WinAuthSample Account";
        ...
        public static readonly LocalText SiteTitle = "WinAuthSample";
    }

    public static class Navigation
    {
        public static readonly LocalText Dashboard = "Dashboard";
        public static readonly LocalText LogoutLink = "Re-Login as Windows user"; // winauth change
        public static readonly LocalText LogoutLinkAppUser = "Re-Login as App User"; //winauth addition
        public static readonly LocalText SiteTitle = "WinAuthSample";
    }
